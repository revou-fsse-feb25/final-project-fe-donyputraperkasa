...
import CartAdmin from '@/app/coba-cart/admin/cartAdmin';
import ContentCartAdmin from '@/app/coba-cart/admin/contentCartAdmin';
        ...
        <div className="min-h-screen bg-gradient-to-br from-blue-800 via-emerald-700 to-green-600 p-8 text-white font-sans">
            ...
            <div className="flex flex-col items-center justify-center space-y-4 mb-10">
                ...
                <div className="bg-white/10 p-4 rounded-xl text-center w-full max-w-md shadow">
                    ...
                    <p className="text-sm text-white/80">admin@example.com</p>
                </div>
            ...
            <CartAdmin selectedMenu={selectedMenu} setSelectedMenu={setSelectedMenu} />
            <ContentCartAdmin selectedMenu={selectedMenu} />
            <Footer/>
        </div>
    );
}
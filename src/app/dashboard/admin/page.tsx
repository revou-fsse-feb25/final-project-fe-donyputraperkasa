...
import DashboardContentAdmin from '../../components/dashboardContentAdmin';
import DashboardMenuAdmin from '../../components/dashboardAdmin';
...
export default function DashboardAdmin() {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-blue-800 via-emerald-700 to-green-600 p-8 text-white font-sans">
            ...
            <DashboardMenuAdmin selectedMenu={selectedMenu} setSelectedMenu={setSelectedMenu} />
            <DashboardContentAdmin selectedMenu={selectedMenu} />
            <Footer/>
        </div>
    );
}
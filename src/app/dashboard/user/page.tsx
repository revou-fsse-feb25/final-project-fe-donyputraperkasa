...
import DashboardMenuUser from '../../components/dashboardUser';
import DashboardContentUser from '../../components/dashboardContentUser';
...
export default function Dashboard() {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-blue-800 via-emerald-700 to-green-600 p-8 text-white font-sans">
            ...
            <DashboardMenuUser selectedMenu={selectedMenu} setSelectedMenu={setSelectedMenu} />
            <DashboardContentUser selectedMenu={selectedMenu} />

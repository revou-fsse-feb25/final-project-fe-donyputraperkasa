...
export default function DashboardMenuUser({ selectedMenu, setSelectedMenu }: Props) {
    return (
        <div>
            {/* Menu Dashboard */}
            <div className="flex flex-wrap justify-center px-4">
                <div className="flex flex-wrap justify-center gap-4 w-full">
                    ...
                    <div
                        onClick={() => setSelectedMenu("Materi dari Tentor")}
                        className={`w-full sm:w-[48%] lg:w-[23%] p-6 mt-4 mb-4 rounded-2xl shadow-xl cursor-pointer text-center sm:text-left transition-all duration-300 
                        ${selectedMenu === "Materi dari Tentor"
                            ? "bg-white/30 ring-2 ring-yellow-300 scale-105"
                            : "bg-gradient-to-br from-white/10 to-white/5 hover:scale-105 hover:bg-white/20 border border-white/20"
                        }`}
                    >
                        <h2 className="text-2xl font-semibold mb-2">📘 Materi dari Tentor</h2>
                        <p className="text-sm text-white/90">Akses materi pembelajaran langsung dari tentor kamu.</p>
                    </div>
                    ...
                    <div
                        onClick={() => setSelectedMenu("Profil Tentor")}
                        className={`w-full sm:w-[48%] lg:w-[23%] p-6 mt-4 mb-4 rounded-2xl shadow-xl cursor-pointer text-center sm:text-left transition-all duration-300 
                    ...
                    >
                        <h2 className="text-2xl font-semibold mb-2">👨‍🏫 Profil Tentor</h2>
                        <p className="text-sm text-white/90">Kenali pengajar hebat yang membimbing kamu.</p>
                    </div>

                    <div
                        onClick={() => setSelectedMenu("Live Chat Developer")}
                        className={`w-full sm:w-[48%] lg:w-[23%] p-6 mt-4 mb-4 rounded-2xl shadow-xl cursor-pointer text-center sm:text-left transition-all duration-300 
                    ...
                    >
                        <h2 className="text-2xl font-semibold mb-2">💬 Live Chat Developer</h2>
                        <p className="text-sm text-white/90">Tanyakan langsung ke developer untuk feedback atau bantuan.</p>
                    </div>
                </div>
            </div>
        </div>
